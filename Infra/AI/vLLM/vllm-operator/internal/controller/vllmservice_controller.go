...
// +kubebuilder:rbac:groups=inference.ixecd.dev,resources=vllmservices,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=inference.ixecd.dev,resources=vllmservices/status,verbs=get;update;patch
// +kubebuilder:rbac:groups=inference.ixecd.dev,resources=vllmservices/finalizers,verbs=update
